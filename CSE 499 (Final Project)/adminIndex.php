<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg p-3 mb-5 ">
  <a class="navbar-brand" href="index.php">Life Shield</a>
...
<div class="container  rounded"> 
  ...
  <div>
    <?php 
     ...
     echo "<h2 class='shadow-lg p-3 mb-5 bg-light rounded mx-auto' style='width: 550px;'>The Overall Donations Are in Taka ".$rows[0]['SUM(donationS)']." </h2>" ;
    ?>
  </div> 
  <div class = "row ">
    <div class="col-6 "><h3>Dhaka Donors</h3></div>
    <div class="col-6"><h3>Sylhet Donors</h3></div>
  </div>
  <div class = "row ">
    <div class="col-6">
   ...
   <div class = "row">
    <div class="col-6"><h3>Rangpur Donors</h3></div>
    <div class="col-6"><h3>Chittagong Donors</h3></div>
