		...
		<div id="container">
            ...
            <div class="info">
                ...
                <p id="create">Account Created At : <?php echo $row["Created_At"]; ?></p>
                   ...
                   <!--<div> <button class="onebtn" type="button"><span></span>
                        <a class="blctxt" href="#" style="text-decoration:none;color:black">Donor</a> 
                    </button>
                    </div>
                    <div>
                    <button class="twobtn" type="button"><span></span>
                        <a class="blctxt" href="#" style="text-decoration:none;color:white">Seeker</a> 
                    </button>
                    </div>-->
            ...
            <div id="bodyText">
               ...
               <!-- <p id="bio">Bai Chao is an electrical engineer for Beijing National Communications. Bai is a graduate of Beijing University and Yale University.</p>-->
			 	<div id="soc">  
