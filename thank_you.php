...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="what_are_you.css">
  ...
  <body>
      ...
      <header id="header">
          <nav  class="navbar navbar-expand-lg px4">
              <a href="#"class="navbar-brand">
                  <span id="ls" class="font-weight-bold text-uppercase logo">
                      Life Shield
                  </span>
              </a>
              ...
              <div class="nav-info-items d-none d-lg-flex">
                ...
                <div class="nav-info align-items-center d-flex justify-content-between mx-lg-5">
                  <span id="whats" class="info-icon mx-lg-3">
      ...
      <body>
          <div class="banner">
            <div class="content">
                <h1>Thank You!!!</h1>
                <p>Thank you so much for your donation. Keep donating for the mankind to rise up the bar of humanity. </p>
